...
Current version: **v0.1.2**. Status: final-prep / feature-complete. The active roadmap phases are closed, and any remaining ideas are tracked in the roadmap's archived / future wishlist section instead of being left open in the shipped checklist.
