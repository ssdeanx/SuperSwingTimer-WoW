...
Current version: **v0.1.5**. Status: active development -- target debuff duration bars for all melee classes with spell icons, dynamic stacking, and nil-guard hardening. Dual-client IsPlayerSpell guards and CD-type buff icon refactoring completed.
